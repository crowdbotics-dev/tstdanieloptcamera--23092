...
## Project Structure
    ...
    ├── tstdanieloptcamera__23092  # Django project configurations
...
1. Clone this repo and `cd tstdanieloptcamera__23092`
...
2. Clone this repo and `cd tstdanieloptcamera__23092`
